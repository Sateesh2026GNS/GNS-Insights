...
export default function EmptyState({ icon = "clipboard", title, description, actionLabel, actionHref, onActionClick }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-600 bg-slate-50/50 dark:bg-slate-800/30 py-16 px-8 text-center">
